...
pub fn build_cli() -> App<'static, 'static> {
    App::new(env!("CARGO_PKG_NAME"))
            ...
            .subcommand(SubCommand::with_name("multiscore")
                .about("Computes similarity scores between all pairs. If one file list is provided, scores will be calculated among all unique file pairs in the list. If two file lists are provided, scores will be calculated among all file pairs between the two lists.")
                .arg(Arg::with_name("file_list1")
                    .help("Required. The first list of files to compare.")
                    .required(true))
                .arg(Arg::with_name("file_list2")
                    .help("Optional. The second list of files to compare. See general subcommand help for context.")
                    .required(false))
